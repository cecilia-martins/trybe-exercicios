...
console.log(`Losango de D 32cm e d 28cm: ${Exercise.losangoArea(32, 28)}cm²`);
console.log(`Losango de D 200cm e d 50cm: ${Exercise.losangoArea(200, 50)}cm²`);
console.log(`Losango de D 75cm e d 25cm: ${Exercise.losangoArea(75, 25)}cm²`);

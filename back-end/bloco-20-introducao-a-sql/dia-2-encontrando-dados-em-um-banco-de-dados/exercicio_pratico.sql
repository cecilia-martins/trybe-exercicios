...
SELECT CONCAT("O projeto ", name," precisou de ", hours, " horas para ser concluído.") AS string FROM Scientists.Projects;
...
SELECT name FROM Scientists.Projects ORDER BY hours DESC;
SELECT name FROM Scientists.Projects ORDER BY hours ASC LIMIT 1 OFFSET 1;
SELECT name FROM Scientists.Projects ORDER BY hours ASC;
SELECT * FROM Scientists.Projects ORDER BY hours ASC LIMIT 5;
SELECT * FROM Scientists.Projects ORDER BY hours;
